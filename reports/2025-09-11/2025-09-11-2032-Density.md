...
### Terminology Note
**Thresholds**: All density thresholds are applied inclusively (≥). For example, '≥0.5 runners/m' means 0.5 or higher density values trigger the threshold.
...
|-----|---------------------------|--------------------------|-------------|
| A | 0.00 - 0.31 | 0.00 - 0.10 | Comfortable |
| B | 0.31 - 0.43 | 0.10 - 0.20 | Good |
| C | 0.43 - 0.72 | 0.20 - 0.40 | Moderate |
| D | 0.72 - 1.08 | 0.40 - 0.50 | Busy |
| E | 1.08 - 1.63 | 0.50 - 0.80 | Very Busy |
| F | 1.63+ | 0.80+ | Critical |
...
**Density Analysis:**
- High runner density in Start to Queen/Regent segment

**Operational Implications:**
- Consider additional crowd management measures
...
| Peak Crowd Density | 0.409 runners/m | D |
| P95 Areal Density | 0.079 runners/m² | A |
| P95 Crowd Density | 0.396 runners/m | C |
| Mean Areal Density | 0.047 runners/m² | A |
| Mean Crowd Density | 0.234 runners/m | C |
...
| Peak Crowd Density | 0.682 runners/m | E |
| P95 Areal Density | 0.117 runners/m² | A |
| P95 Crowd Density | 0.584 runners/m | E |
| Mean Areal Density | 0.036 runners/m² | A |
| Mean Crowd Density | 0.181 runners/m | B |
...
| P95 Crowd Density | 0.951 runners/m | F |
| Mean Areal Density | 0.081 runners/m² | A |
| Mean Crowd Density | 0.407 runners/m | D |
...
**Density Analysis:**
- High runner density in Queen/Regent to WSB mid-point segment
...
| Peak Crowd Density | 0.533 runners/m | E |
| P95 Areal Density | 0.102 runners/m² | A |
| P95 Crowd Density | 0.508 runners/m | E |
| Mean Areal Density | 0.068 runners/m² | A |
| Mean Crowd Density | 0.340 runners/m | C |
...
| P95 Crowd Density | 0.931 runners/m | F |
| Mean Areal Density | 0.113 runners/m² | A |
| Mean Crowd Density | 0.565 runners/m | E |
...
| P95 Crowd Density | 0.993 runners/m | F |
| Mean Areal Density | 0.088 runners/m² | A |
| Mean Crowd Density | 0.441 runners/m | D |
...
**Density Analysis:**
- High runner density in WSB mid-point to Friel segment
...
| Peak Crowd Density | 0.603 runners/m | E |
| P95 Areal Density | 0.119 runners/m² | A |
| P95 Crowd Density | 0.594 runners/m | E |
| Mean Areal Density | 0.070 runners/m² | A |
| Mean Crowd Density | 0.348 runners/m | C |
...
| Peak Crowd Density | 0.957 runners/m | F |
| P95 Areal Density | 0.179 runners/m² | A |
| P95 Crowd Density | 0.897 runners/m | F |
| Mean Areal Density | 0.109 runners/m² | A |
| Mean Crowd Density | 0.546 runners/m | E |
...
| Mean Crowd Density | 0.397 runners/m | C |
...
**Density Analysis:**
- High runner density in Friel to 10K Turn segment
...
| Peak Crowd Density | 0.449 runners/m | D |
| P95 Areal Density | 0.294 runners/m² | A |
| P95 Crowd Density | 0.440 runners/m | D |
| Mean Areal Density | 0.180 runners/m² | A |
| Mean Crowd Density | 0.270 runners/m | C |
...
| P95 Crowd Density | 0.435 runners/m | D |
| Mean Areal Density | 0.120 runners/m² | A |
| Mean Crowd Density | 0.179 runners/m | B |
...
**Density Analysis:**
- High runner density in 10K Turn to Friel segment
...
| Peak Crowd Density | 0.295 runners/m | C |
| P95 Areal Density | 0.193 runners/m² | A |
| P95 Crowd Density | 0.290 runners/m | C |
| Mean Areal Density | 0.109 runners/m² | A |
| Mean Crowd Density | 0.164 runners/m | B |
...
| P95 Crowd Density | 0.288 runners/m | C |
| Mean Areal Density | 0.080 runners/m² | A |
| Mean Crowd Density | 0.120 runners/m | B |
...
**Density Analysis:**
- High runner density in 10K Turn to Full Turn Blake (Out) segment
...
**Density Analysis:**
- High runner density in Full Turn Blake to 10K Turn (Return) segment
...
**Density Analysis:**
- High runner density in Friel to Station Rd. segment
...
|--------|-------|----------|
| Peak Areal Density | 0.035 runners/m² | A |
| Peak Crowd Density | 0.104 runners/m | B |
| P95 Areal Density | 0.033 runners/m² | A |
| P95 Crowd Density | 0.100 runners/m | B |
...
**Density Analysis:**
- High runner density in Full Loop around QS to Trail/Aberdeen segment
...
**Density Analysis:**
- High runner density in Trail/Aberdeen to/from Station Rd segment
...
**Density Analysis:**
- High runner density in Station Rd to Bridge/Mill segment
...
**Density Analysis:**
- High runner density in Bridge/Mill to Half Turn (Outbound) segment
...
**Density Analysis:**
- High runner density in Half Turn to Full Turn (Out) segment
...
**Density Analysis:**
- High runner density in Full Turn to Half Turn (Return) segment
...
**Density Analysis:**
- High runner density in Half Turn to Bridge/Mill segment
...
**Density Analysis:**
- High runner density in Half Turn to Bridge/Mill (Slow Half) segment
...
**Density Analysis:**
- High runner density in Bridge/Mill to Station Rd segment
...
**Density Analysis:**
- High runner density in Station Rd to Trail/Aberdeen segment
...
**Density Analysis:**
- High runner density in Trail/Aberdeen to Finish (Full to Loop) segment
...
**Density Analysis:**
- High runner density in Trail/Aberdeen to Finish segment
