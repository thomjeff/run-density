...
def generate_markdown_report(
    ...
    content.append("|-----|---------------------------|--------------------------|-------------|")
    content.append("| A | 0.00 - 0.31 | 0.00 - 0.10 | Comfortable |")
    content.append("| B | 0.31 - 0.43 | 0.10 - 0.20 | Good |")
    content.append("| C | 0.43 - 0.72 | 0.20 - 0.40 | Moderate |")
    content.append("| D | 0.72 - 1.08 | 0.40 - 0.50 | Busy |")
    content.append("| E | 1.08 - 1.63 | 0.50 - 0.80 | Very Busy |")
    content.append("| F | 1.63+ | 0.80+ | Critical |")
    content.append("")
